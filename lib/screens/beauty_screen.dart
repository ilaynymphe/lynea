...
class _BeautyScreenState extends State<BeautyScreen> {
  ...
  void _deleteSelected(Box<MakeupItem> box) {
    showDialog(
      context: context,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: _selectionMode
          ...
          : AppBar(title: Text(tr('beauty_title'))),
            ...
            children: [
              ...
              Expanded(
                child: ValueListenableBuilder(
                  ...
                  builder: (context, Box<MakeupItem> box, _) {
                    ...
                    if (_searchQuery.isNotEmpty) {
                      items = items.where((item) {
                        return item.name.toLowerCase().contains(_searchQuery) ||
                            ...
                            item.shade.toLowerCase().contains(_searchQuery);
                      }).toList();
                    }

                    if (items.isEmpty) {
                      return Center(
                        child: Text(_searchQuery.isNotEmpty ? tr('search_no_results') : tr('beauty_empty')),
                      );
                    }
                            ...
                            leading: _selectionMode
                                ...
                                : CircleAvatar(
                                    ...
                                    child: item.imagePath != null
                                        ...
                                        : const Icon(Icons.brush, color: Color(0xFFB185A7)),
                                  ),
                                        ...
                                        onSelected: (value) {
                                          if (value == 'edit') {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => AddMakeupScreen(existingItem: item),
                                              ),
                                            );
      ...
      floatingActionButton: _selectionMode
          ...
          : FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const AddMakeupScreen()),
                );
              },
